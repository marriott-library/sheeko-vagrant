...
parser.add_argument(
    ...
    type=str,
    help="""\
              Path to training set captions file
              """
)
parser.add_argument(
    '--test_set_caption',
    type=str,
    help="""\
              Path to testing set captions file
              """
)
parser.add_argument(
    '--output_path',
    type=str,
    help="""\
              Path to directory of output TF records
              """
)
...
TRAIN_IMAGE_DIR = "/nfs/lyrasis/colldata_nlp_april/train_set/train/images/"
TRAIN_ANNOTATION_DIR = "/nfs/lyrasis/colldata_nlp_april/train_set/train/annotations/annotation.json"
TEST_IMAGE_DIR = "/nfs/lyrasis/colldata_nlp_april/train_set/test/images/"
TEST_ANNOTATION_DIR = "/nfs/lyrasis/colldata_nlp_april/train_set/test/annotations/annotation.json"
'''
TRAIN_IMAGE_DIR = "/nfs/lyrasis/test/train/images/"
TRAIN_ANNOTATION_DIR =  "/nfs/lyrasis/test/train/annotations/annotation.json"
TEST_IMAGE_DIR = "/nfs/lyrasis/test/test/images/"
TEST__ANNOTATION_DIR =  "/nfs/lyrasis/test/test/annotations/annotation.json"
'''
OUTPUT_TF_DIR = "/nfs/lyrasis/colldata_nlp_april/converted_new/TF/"
OUTPUT_DICTIONARY_DIR = "/nfs/lyrasis/colldata_nlp_april/converted_new/Dictionary/word_count.txt"

TRAIN_IMAGE_DIR = args.train_set_image
TEST_IMAGE_DIR = args.test_set_image
TRAIN_ANNOTATION_DIR = args.train_set_caption
TEST_ANNOTATION_DIR = args.test_set_caption
OUTPUT_TF_DIR = args.output_path
OUTPUT_DICTIONARY_DIR = os.path.join(args.output_path, "word_count.txt")
...
# input training set folder and val set folder
tf.flags.DEFINE_string("train_image_dir", TRAIN_IMAGE_DIR,
                       "Training image directory.")
tf.flags.DEFINE_string("val_image_dir", TEST_IMAGE_DIR,
                       "Validation image directory.")
# input training set and val set annotation folder
tf.flags.DEFINE_string("train_captions_file", TRAIN_ANNOTATION_DIR,
                       "Training captions JSON file.")
tf.flags.DEFINE_string("val_captions_file", TEST_ANNOTATION_DIR,
                       "Validation captions JSON file.")
# output dir
tf.flags.DEFINE_string("output_dir", OUTPUT_TF_DIR, "Output data directory.")
...
tf.flags.DEFINE_string("word_counts_output_file", OUTPUT_DICTIONARY_DIR,
...
def _load_and_process_metadata(captions_file, image_dir):
    ...
    id_to_filename = [(int(x["id"]), x["file_name"]) for x in caption_data["images"]]

    # Extract the captions. Each image_id is associated with multiple captions.
    id_to_captions = {}
    for annotation in caption_data["annotations"]:
        image_id = int(annotation["image_id"])
        caption = re.sub(r'[^\x00-\x7F]+', " ", annotation["caption"])
